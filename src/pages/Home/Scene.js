    ...
    <BasicPageWrapper {...props}>
      ...
      >
        <HeroLeft>
          ...
          <HeroSubtitle>
            {
              'Meteorite helps organize, filter, and prioritize your\
                          GitHub notifications to make your life easier'
            }
          </HeroSubtitle>
          <FlexBreak />
          <div
      ...
      <Outer alt>
        <Container column>
          ...
          <Subtitle>
            {
              'GitHub notifications can actually be your friend – with a little bit of discipline.\
                      All we need to do is filter out the noise & organize things in a way that makes sense.'
            }
          </Subtitle>
          <WorkflowToggle
            easeTimingMs={100}
            items={[
              {
                ...
                description:
                  "Stay focused on the important things. We'll only show the notifications that matter to you.",
                image: ScreenshotPng
              },
              {
                id: 1,
                ...
                description:
                  "When things stand out, you shouldn't miss it. We mark notifications when there's something interesting going down.",
                image: ReasonsPng
              },
              {
                id: 2,
                ...
                description:
                  "Don't get lost at sea – the most important notifications stay at the top of the list.",
                image: ScoresPng
              }
            ]}
          />
      ...
      <Container column>
        ...
        <Subtitle>
          {'All of the features of Meteorite are specifically designed'}
          <br />
